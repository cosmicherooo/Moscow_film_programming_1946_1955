...
# высчитаем значение POPSTAT для кинокартин Адмирал Ушаков, Застава в горах,
# Веселые звезды, Судьба Марины в промежутке между 1953 и 1954 годами
# без различения по кинотеатрам, но с различением POPSTAT для кинокартин по годам.
testing_query_1 = screenings_per_film(film_name=('Адмирал Ушаков',
                                                 'Застава в горах', 'Веселые звезды',
                                                 'Судьба Марины'),
                                      start_date=(1953, 1, 1),
                                      end_date=(1954, 12, 31),
                                      is_cinema = False,
